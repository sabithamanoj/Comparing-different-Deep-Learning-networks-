...
from model_definition_mobilenet import MobileNet
...
def main():
    ...
    #Log file
    logging.basicConfig(filename='training_eval_mobilenet.log', level=logging.INFO, filemode='w', format='%(message)s')
