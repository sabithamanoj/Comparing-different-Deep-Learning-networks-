...
from model_definition_inceptionv3 import InceptionV3
...
def main():
    ...
    #Log file
    logging.basicConfig(filename='training_eval_inceptionv3.log', level=logging.INFO, filemode='w', format='%(message)s')
